...
public class MinimizeMaximumPairSum { // Class name fixed
    ...
    public static void main(String[] args) {
        MinimizeMaximumPairSum solution = new MinimizeMaximumPairSum(); // Fixed incorrect class name
        int[] nums = {3, 5, 2, 7, 1, 6, 4};

        int minPairSum = solution.minPairSum(nums);

        System.out.println("Minimum Pair Sum: " + minPairSum);
    }
}
